...
- **`antares_legacy_models.yml`** — Defines models for: `area`, `load`, `link`, `renewable`, `thermal`, `short_term_storage`, `miscellaneous_fatal_generation`. These mirror the implicit models in the Antares solver.
