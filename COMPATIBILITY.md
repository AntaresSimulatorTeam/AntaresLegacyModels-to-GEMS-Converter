...
|-----------|-------------------|---------------|--------|-------|
| 0.4.0     | 10.1.1            | 0.17.0        | 0.1.3  | antares-craft 0.17.0 (feature: new `create_multiple_binding_constraints` method; 0.16.0 added `get_mc_ind_binding_constraints`/`get_mc_all_binding_constraints` result readers) — additive only, no breaking changes, no converter code changes required |
...
|-----------|----------------|--------------|
| Converter | 0.4.0 | `pyproject.toml` |
...
| antares-craft | 0.17.0 | `pyproject.toml` |
